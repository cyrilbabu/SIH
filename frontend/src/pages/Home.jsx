    ...
    <div className="flex min-h-screen bg-gradient-to-r from-blue-100 to-gray-200">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800">Home Dashboard</h1>
          <button className="flex items-center bg-gradient-to-r from-blue-500 to-blue-700 text-white text-xl px-4 py-1 rounded-lg shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-105">
            <CgProfile className="mr-2" /> User Name
          </button>
        </div>
